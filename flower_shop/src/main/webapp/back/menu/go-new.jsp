...
<main>
    <div class="bx">
        <div class="add">上架鲜花</div>
        <div class="group">
            <form action="${pageContext.request.contextPath}/flower/add" method="post" enctype="multipart/form-data">
                <table>
                    <!---->
                    <tr>
                        <td>鲜花名称 :</td>
                        ...
                        <td>鲜花材料 :</td>
                        <td><input type="text" name="flower.material"></td>
                    </tr>
                    <tr>
                        <td>鲜花类别 :</td>
                        <td>
                        ...
                        <td>花语 :</td>
                        <td><input type="text" name="flower.language"></td>
                    </tr>

                    <tr>
                        <td>原价 :</td>
                        <td><input type="number" name="flower.price"></td>
                        <td>封面 :</td>
                        <td rowspan="3">
                            <label id="file_upload1_label" for="file_upload1">
                                <span id="uploadtip">添加花束图书</span>
                                <img name="" id="uploadimg" src="" alt="" width="118px" height="143px"/>
                            </label>
                    ...
                    <tr>
                        <td>优惠价 :</td>
                        <td><input type="number" name="flower.myprice"></td>
                        <td></td>
                    </tr>
                </table>
