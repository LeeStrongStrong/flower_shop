    ...
    <div class="bx">
        <aside>
            ...
            <ul>
                ...
                <li  class="current"><a href="${pageContext.request.contextPath}/user/selectAllUser">用户管理</a></li>
        ...
        <div class="right">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>${user.status}</td>
                    <td><span class="change" onclick="location.href='${pageContext.request.contextPath}/user/updateStatus?status=${user.status}&userId=${user.id}'">修改</span></td>
                </tr>
                </c:forEach>
                <tr>
                    <td></td>
