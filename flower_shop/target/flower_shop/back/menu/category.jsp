...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/back/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/back/css/base.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/back/css/category.css">
</head>
<body>
<!--头部部分-->
<header>
...
<main>
    <div class="bx">
        <aside>
            <h3>系统主菜单</h3>
            <ul>
                <li class="current"><a href="${pageContext.request.contextPath}/category/findAll">类别管理</a></li>
        ...
        <div class="right">
           ...
           <table>
            ...
            <c:forEach items="${requestScope.categorys}" var="category">
               <tr>
                   <td colspan="4">${category.id}</td>
                   <td colspan="2">${category.name}</td>
                    <td colspan="2">
                    <span class="button delete" onclick="location.href='${pageContext.request.contextPath}/category/removeCategory?id=${category.id }' ">删除</span>
                    </td>
