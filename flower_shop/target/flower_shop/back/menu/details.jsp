...
<main>
    <div class="bx">
        ...
        <div class="right">
            ...
            <table>
                <tr>
                    <th colspan="2">订单号:${order.orderNo }</th>
             ...
             <c:forEach items="${requestScope.orderItems}" var="orderItem">
                 ...
                 <td style="width: 100px;"><img style="width:32px;height: 20px" src="${pageContext.request.contextPath}/back/images/img/${orderItem.flower.image}"></td>
                 <td style="width: 300px;">单价：¥${orderItem.flower.price}</td>
                 <td style="width: 300px;">优惠价：¥${orderItem.flower.myprice}</td>
                 <th colspan="3" style="width: 300px;">${orderItem.count}束</th>
                 </tr>
             </c:forEach>
                <tr>
                <td></td>
